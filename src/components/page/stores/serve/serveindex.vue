    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="serveitem" border class="table"  @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="servetype" label="服务类型" sortable width="110">
                </el-table-column>
                <el-table-column prop="pets" label="宠物类型" width="120">
                </el-table-column>
                <el-table-column prop="severname" label="服务名称">
                </el-table-column>
                <el-table-column prop="guige" label="适用规格">
                </el-table-column>
                <el-table-column prop="servetime" label="预约时间">
                </el-table-column>
                <el-table-column prop="serveresource" label="服务规格">
                </el-table-column>
